---
name: novel-import-ttp-storyboard-preset
description: 将当前 Project upload/ 中用户明确选择的 TTP（text-to-picture）Context JSON 转换为可审查的 Storyboard 与 Tag Pattern companion candidates。
---
