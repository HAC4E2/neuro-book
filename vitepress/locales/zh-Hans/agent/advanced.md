...
- [Harness Black-Box Contract](https://github.com/notnotype/neuro-book/blob/master/.agents/tasks/18-agent-runtime-pipeline-hooks/HARNESS-BLACK-BOX-CONTRACT.md)：prompt / continue / steer / followup 的外部行为合同。
