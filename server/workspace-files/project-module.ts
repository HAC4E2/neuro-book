...
export type ProjectModuleName = "database" | "history" | "file-index" | "plot-world" | "agent-sql" | "text-to-image";
...
const LAZY_MODULE_ORDER: readonly ProjectModuleName[] = ["plot-world", "agent-sql", "text-to-image"];
