...
function buildAgentTools() {
    ...
    return {
        ...
        inspectTtpStoryboard: requireDefinition(storyboardImportTools, "inspect_ttp_storyboard"),
        submitTtpStoryboardConversion: requireDefinition(storyboardImportTools, "submit_ttp_storyboard_conversion"),
