...
const textToImageProjectSurfaceActive = computed(() => projectSurfaceActive.value
...
watch(textToImageProjectSurfaceActive, (active) => {
    if (active) return;
    textToImageWorkbenchOpen.value = false;
    textToImageInitialSection.value = "llm";
    textToImageInitialCharacter.value = null;
...
function openTextToImageWorkbench(): void {
    if (!textToImageProjectSurfaceActive.value) return;
    textToImageInitialCharacter.value = null;
    textToImageInitialSection.value = "llm";
    textToImageWorkbenchOpen.value = true;
}
...
<template>
    ...
    >
        ...
        <NovelIdeActivityBar
            ...
            @open-text-to-image="openTextToImageWorkbench"
        ...
        <TextToImageWorkbenchDialog
            v-if="textToImageProjectSurfaceActive"
