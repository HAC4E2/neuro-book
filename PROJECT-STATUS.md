...
- `0.9.3-canary` 当前按限量 canary 准备：Manager `0.1.0-canary.52` 已发布并通过公开 provenance；随后由 release workflow 完成 NeuroBook 公开资产与 GHCR 验证。真实 provider 和人工 Agent/Workflow 全流程作为已知未完成项记录，不写成全量通过。
